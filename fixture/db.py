...
class DbFixture:
    ...
    def get_contact_list(self):
        ...
        cursor = self.connection.cursor()
        try:
            cursor.execute("select id,firstname,middlename,lastname,nickname,address,home,mobile,work,phone2,email,email2,email3 from addressbook")
            for row in cursor:
                (id, firstname, middlename, lastname, nickname, address, homephone, mobilephone, workphone,
